        ...
        <div className="space-y-2">
          {matches.map((m) => (
            <button
              ...
              className={`w-full text-left bg-white border rounded-sm px-3 py-2.5 flex items-center justify-between ${activeMatch?.id === m.id ? "border-amberx" : "border-gray-300 hover:border-amberx/60"}`}
            >
